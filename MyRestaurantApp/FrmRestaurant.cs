...
public partial class FrmRestaurant : Form
{
    ...
    Color emptyBackgroundColor = Color.DarkSeaGreen;
    ...
    private void ShowAdditionForm(object sender, EventArgs e)
    {
        ...
        formAddition.Show(); //formu göstermek
    ...
    private void CreateTables()
    {
        ...
        ApplicationDbContext context = new(); //instance türettim yani örneðini aldým.
        tables = context.Tables.ToList(); //SELECT * FROM Tables kodunu çalýþtýrýyor bu ToList kodu.Tablo listesini aldým ve deðiþkenime set ettim

        //tableCount = tables.Count(); //table sayýmý elde eder.
        ...
        foreach (var table in tables)
        {
            ...
            btn.BackColor = table.IsAvailable ? emptyBackgroundColor : fillBackgroundColor;
    ...
    public void ChangeTableAvailability(int tableNumber)
    {
        ...
        this.Controls.Find(tableName, true)[0].BackColor = table.IsAvailable ? emptyBackgroundColor : fillBackgroundColor;
